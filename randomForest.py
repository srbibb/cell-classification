...
# Takes the features and files from the neural network and classes them between five stages of mitosis.
...
classes = ['Interphase', 'Prometaphase', 'Metaphase', 'Anaphase', 'Telophase']
...
training_x, testing_x, training_y, testing_y = train_test_split(dataset_x, dataset_y, test_size=0.33, stratify=dataset_y)
